    ...
    return (
      ...
      <div className="measure">
        <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
          <legend className="f1 fw6 ph0 mh0" style={{fontWeight: 'bold'}}>Register</legend>
          <div className="mt3">
        ...
        <div className="">
          <input className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f4 dib" type="submit" onClick={this.onSubmitSignUp} value="Register" />
        </div>
      </div>
    </main>
    </article>
